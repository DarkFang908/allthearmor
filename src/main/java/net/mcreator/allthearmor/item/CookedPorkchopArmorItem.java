...
public class CookedPorkchopArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:cooked_porkchop_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:cooked_porkchop_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:cooked_porkchop_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:cooked_porkchop_armor_boots")
	public static final Item boots = null;
	public CookedPorkchopArmorItem(AllthearmorModElements instance) {
		super(instance, 112);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.COOKED_PORKCHOP, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "cooked_porkchop_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/cookedporkchop_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("cooked_porkchop_armor_helmet"));
