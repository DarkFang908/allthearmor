...
public class ChickenArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:chicken_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:chicken_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:chicken_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:chicken_armor_boots")
	public static final Item boots = null;
	public ChickenArmorItem(AllthearmorModElements instance) {
		super(instance, 127);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.CHICKEN, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "chicken_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/chicken_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("chicken_armor_helmet"));
