...
public class ShulkerArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:shulker_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:shulker_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:shulker_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:shulker_armor_boots")
	public static final Item boots = null;
	public ShulkerArmorItem(AllthearmorModElements instance) {
		super(instance, 172);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.SHULKER_SHELL, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "shulker_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/shulker_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("shulker_armor_helmet"));
