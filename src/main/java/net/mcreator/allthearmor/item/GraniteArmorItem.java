...
public class GraniteArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:granite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:granite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:granite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:granite_armor_boots")
	public static final Item boots = null;
	public GraniteArmorItem(AllthearmorModElements instance) {
		super(instance, 249);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.GRANITE, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "granite_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/granite_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("granite_armor_helmet"));
