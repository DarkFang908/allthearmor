...
public class TitaniumAxeItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:titanium_axe")
	public static final Item block = null;
	public TitaniumAxeItem(AllthearmorModElements instance) {
		super(instance, 403);
	}
