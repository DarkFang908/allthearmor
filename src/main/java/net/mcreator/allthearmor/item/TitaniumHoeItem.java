...
public class TitaniumHoeItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:titanium_hoe")
	public static final Item block = null;
	public TitaniumHoeItem(AllthearmorModElements instance) {
		super(instance, 406);
	}
