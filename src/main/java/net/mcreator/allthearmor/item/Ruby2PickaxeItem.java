...
public class Ruby2PickaxeItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:ruby_2_pickaxe")
	public static final Item block = null;
	public Ruby2PickaxeItem(AllthearmorModElements instance) {
		super(instance, 382);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ruby_2_pickaxe"));
	}
}
