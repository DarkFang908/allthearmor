...
public class EyeArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:eye_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:eye_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:eye_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:eye_armor_boots")
	public static final Item boots = null;
	public EyeArmorItem(AllthearmorModElements instance) {
		super(instance, 202);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.ENDER_EYE, (int) (1)));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/eye_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("eye_armor_helmet"));
