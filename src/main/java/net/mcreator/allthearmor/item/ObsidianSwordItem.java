...
public class ObsidianSwordItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:obsidian_sword")
	public static final Item block = null;
	public ObsidianSwordItem(AllthearmorModElements instance) {
		super(instance, 29);
	}
