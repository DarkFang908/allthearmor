...
public class MagmaCreamArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:magma_cream_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:magma_cream_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:magma_cream_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:magma_cream_armor_boots")
	public static final Item boots = null;
	public MagmaCreamArmorItem(AllthearmorModElements instance) {
		super(instance, 279);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.MAGMA_CREAM, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "magma_cream_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/magmacream_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("magma_cream_armor_helmet"));
