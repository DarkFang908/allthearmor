...
public class AndesiteArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:andesite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:andesite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:andesite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:andesite_armor_boots")
	public static final Item boots = null;
	public AndesiteArmorItem(AllthearmorModElements instance) {
		super(instance, 239);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.ANDESITE, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "andesite_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/andesite_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("andesite_armor_helmet"));
