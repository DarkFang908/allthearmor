...
public class Emerald_ShovelItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:emerald_shovel")
	public static final Item block = null;
	public Emerald_ShovelItem(AllthearmorModElements instance) {
		super(instance, 9);
	}
