...
public class PoppedChorusArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:popped_chorus_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:popped_chorus_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:popped_chorus_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:popped_chorus_armor_boots")
	public static final Item boots = null;
	public PoppedChorusArmorItem(AllthearmorModElements instance) {
		super(instance, 324);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.POPPED_CHORUS_FRUIT, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "popped_chorus_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/poppedchorus_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("popped_chorus_armor_helmet"));
