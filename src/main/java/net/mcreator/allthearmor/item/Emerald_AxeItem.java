...
public class Emerald_AxeItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:emerald_axe")
	public static final Item block = null;
	public Emerald_AxeItem(AllthearmorModElements instance) {
		super(instance, 7);
	}
