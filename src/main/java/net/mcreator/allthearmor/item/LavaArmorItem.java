...
public class LavaArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:lava_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:lava_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:lava_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:lava_armor_boots")
	public static final Item boots = null;
	public LavaArmorItem(AllthearmorModElements instance) {
		super(instance, 177);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.LAVA_BUCKET, (int) (1)));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/lava_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("lava_armor_helmet"));
