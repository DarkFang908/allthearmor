...
public class DirtArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:dirt_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:dirt_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:dirt_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:dirt_armor_boots")
	public static final Item boots = null;
	public DirtArmorItem(AllthearmorModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/dirt_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("dirt_armor_helmet"));
