...
public class CopperSwordItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:copper_sword")
	public static final Item block = null;
	public CopperSwordItem(AllthearmorModElements instance) {
		super(instance, 394);
	}
