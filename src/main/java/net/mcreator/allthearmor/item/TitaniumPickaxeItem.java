...
public class TitaniumPickaxeItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:titanium_pickaxe")
	public static final Item block = null;
	public TitaniumPickaxeItem(AllthearmorModElements instance) {
		super(instance, 402);
	}
