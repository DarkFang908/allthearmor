...
public class FlintArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:flint_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:flint_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:flint_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:flint_armor_boots")
	public static final Item boots = null;
	public FlintArmorItem(AllthearmorModElements instance) {
		super(instance, 309);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/flint_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("flint_armor_helmet"));
