...
public class WaterArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:water_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:water_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:water_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:water_armor_boots")
	public static final Item boots = null;
	public WaterArmorItem(AllthearmorModElements instance) {
		super(instance, 182);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.WATER_BUCKET, (int) (1)));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/water_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("water_armor_helmet"));
