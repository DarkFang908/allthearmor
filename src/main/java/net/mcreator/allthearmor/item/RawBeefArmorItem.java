...
public class RawBeefArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:raw_beef_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:raw_beef_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:raw_beef_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:raw_beef_armor_boots")
	public static final Item boots = null;
	public RawBeefArmorItem(AllthearmorModElements instance) {
		super(instance, 97);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.BEEF, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "raw_beef_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/rawbeef_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("raw_beef_armor_helmet"));
