...
public class NetherBrickArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:nether_brick_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:nether_brick_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:nether_brick_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:nether_brick_armor_boots")
	public static final Item boots = null;
	public NetherBrickArmorItem(AllthearmorModElements instance) {
		super(instance, 274);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.NETHER_BRICK, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "nether_brick_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/netherbrick_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("nether_brick_armor_helmet"));
