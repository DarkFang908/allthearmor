...
public class Ruby2AxeItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:ruby_2_axe")
	public static final Item block = null;
	public Ruby2AxeItem(AllthearmorModElements instance) {
		super(instance, 383);
	}
