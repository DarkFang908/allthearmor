...
public class Ruby1ArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:ruby_1_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:ruby_1_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:ruby_1_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:ruby_1_armor_boots")
	public static final Item boots = null;
	public Ruby1ArmorItem(AllthearmorModElements instance) {
		super(instance, 377);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/ruby1_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("ruby_1_armor_helmet"));
