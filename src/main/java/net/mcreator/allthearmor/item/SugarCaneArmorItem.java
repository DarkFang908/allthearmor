...
public class SugarCaneArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:sugar_cane_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:sugar_cane_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:sugar_cane_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:sugar_cane_armor_boots")
	public static final Item boots = null;
	public SugarCaneArmorItem(AllthearmorModElements instance) {
		super(instance, 92);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.SUGAR_CANE, (int) (1)));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/sugarcane_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
