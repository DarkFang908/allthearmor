...
public class CookedChickenArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:cooked_chicken_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:cooked_chicken_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:cooked_chicken_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:cooked_chicken_armor_boots")
	public static final Item boots = null;
	public CookedChickenArmorItem(AllthearmorModElements instance) {
		super(instance, 132);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.COOKED_CHICKEN, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "cooked_chicken_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/cookedchicken_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("cooked_chicken_armor_helmet"));
