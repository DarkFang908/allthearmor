...
public class BeaconArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:beacon_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:beacon_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:beacon_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:beacon_armor_boots")
	public static final Item boots = null;
	public BeaconArmorItem(AllthearmorModElements instance) {
		super(instance, 157);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{40, 120, 80, 40}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/beacon_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("beacon_armor_helmet"));
