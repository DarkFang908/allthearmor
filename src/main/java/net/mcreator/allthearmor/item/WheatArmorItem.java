...
public class WheatArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:wheat_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:wheat_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:wheat_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:wheat_armor_boots")
	public static final Item boots = null;
	public WheatArmorItem(AllthearmorModElements instance) {
		super(instance, 254);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.WHEAT, (int) (1)));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/wheat_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("wheat_armor_helmet"));
