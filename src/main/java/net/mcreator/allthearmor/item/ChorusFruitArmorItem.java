...
public class ChorusFruitArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:chorus_fruit_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:chorus_fruit_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:chorus_fruit_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:chorus_fruit_armor_boots")
	public static final Item boots = null;
	public ChorusFruitArmorItem(AllthearmorModElements instance) {
		super(instance, 329);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Items.CHORUS_FRUIT, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "chorus_fruit_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/chorusfruit_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("chorus_fruit_armor_helmet"));
