...
public class DioriteArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:diorite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:diorite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:diorite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:diorite_armor_boots")
	public static final Item boots = null;
	public DioriteArmorItem(AllthearmorModElements instance) {
		super(instance, 244);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.DIORITE, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "diorite_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/diorite_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("diorite_armor_helmet"));
