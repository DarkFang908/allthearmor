...
public class CopperShovelItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:copper_shovel")
	public static final Item block = null;
	public CopperShovelItem(AllthearmorModElements instance) {
		super(instance, 395);
	}
