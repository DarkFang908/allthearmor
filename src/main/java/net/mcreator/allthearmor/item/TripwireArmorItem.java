...
public class TripwireArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:tripwire_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:tripwire_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:tripwire_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:tripwire_armor_boots")
	public static final Item boots = null;
	public TripwireArmorItem(AllthearmorModElements instance) {
		super(instance, 147);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.TRIPWIRE_HOOK, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "tripwire_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/tripwire_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("tripwire_armor_helmet"));
