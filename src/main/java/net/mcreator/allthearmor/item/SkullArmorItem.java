...
public class SkullArmorItem extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:skull_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("allthearmor:skull_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("allthearmor:skull_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("allthearmor:skull_armor_boots")
	public static final Item boots = null;
	public SkullArmorItem(AllthearmorModElements instance) {
		super(instance, 162);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{25, 85, 70, 25}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AllTheArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "allthearmor:textures/models/armor/skull_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("skull_armor_helmet"));
