...
public class RubyBlockBlock extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(AllthearmorModElements instance) {
		super(instance, 373);
	}
