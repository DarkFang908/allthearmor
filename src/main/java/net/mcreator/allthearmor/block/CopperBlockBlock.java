...
public class CopperBlockBlock extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(AllthearmorModElements instance) {
		super(instance, 214);
	}
