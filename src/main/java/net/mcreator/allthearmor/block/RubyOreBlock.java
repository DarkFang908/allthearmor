...
import net.mcreator.allthearmor.item.RubyItem;
...
public class RubyOreBlock extends AllthearmorModElements.ModElement {
	@ObjectHolder("allthearmor:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(AllthearmorModElements instance) {
		super(instance, 372);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("allthearmor:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("allthearmor:ruby_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
